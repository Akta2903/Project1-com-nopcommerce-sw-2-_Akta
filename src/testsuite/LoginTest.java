...
public class LoginTest extends BaseTest
{
    ...
    public void userShouldNavigateToLoginPageSuccessfully()
    {
        ...
        //verifing "Welcome, Please Sign In!" is displayed or not
    ...
    public void userShouldLoginSuccessfullyWithValidCredentials()
    {
        ...
        driver.findElement(By.id("Email")).sendKeys("akta123@gmail.com");
        driver.findElement(By.id("Password")).sendKeys("akta123");

        // clicking login button
        driver.findElement(By.xpath("//button[@class='button-1 login-button']")).click();

        //verifing user is logged in successful or not by verifing the text displayed on the screen
    ...
    public void verifyTheErrorMessage()
    {
        ...
        driver.findElement(By.xpath("//button[@class='button-1 login-button']")).click();
        // verfing the error message displayed or not
